...
def generate_dis_instance(num_experiment_round, benchmark, X, protected_attribs, constraint,
    ...
    for i in range(num_experiment_round):
        ...
        t1 = time.time()
        ids_EIDIG_5, gen_EIDIG_5, total_iter_EIDIG_5, R = EIDIG_wss.individual_discrimination_generation(X, seeds,
                                                                                                         protected_attribs,
                                                                                                         constraint,
                                                                                                         model,
                                                                                                         decay, l_num,
...
def produce_label(dataset_name):
    ...
    ids_C_a_EIDIG_5 = '../logging_data_wss/generated_dis_instances_back_up/C-a_ids_EIDIG_5_1.pkl'
