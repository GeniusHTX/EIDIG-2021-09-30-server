...
adult_EIDIG_5_retrained_model = keras.models.load_model("../models/retrained_models"
                                                        "/adult_EIDIG_5_retrained_model_formal.h5")
...
def main(argv=None):
    ...
    adult_EIDIG_5_retrained_model = keras.models.load_model(
        "../models_wss/retrained_models_formal_dis_ins/adult_EIDIG_5_retrained_model_formal.h5")

    adult_EIDIG_5_retrained_model_no_majority_vote = keras.models.load_model(
        "../models_wss/retrained_models_formal_dis_ins/adult_EIDIG_5_retrained_model_no_majority_vote.h5")

    adult_EIDIG_5_retrained_model_no_majority_vote_10 = keras.models.load_model(
        "../models_wss/retrained_models_formal_dis_ins/adult_EIDIG_5_retrained_model_no_majority_vote_0.1.h5")

    adult_EIDIG_5_retrained_model_no_majority_vote_2 = keras.models.load_model(
        "../models_wss/retrained_models_formal_dis_ins/adult_EIDIG_5_retrained_model_no_majority_vote_0.02.h5")
