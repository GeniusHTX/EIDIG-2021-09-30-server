...
model.save("../models_htx/original_models/adult_model.h5")


# The precision rate is  0.7338425381903643 , the recall rate is  0.5454148471615721 ,
# and the F1 score is 0.625751503006012